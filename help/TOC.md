...
+ 銷售分析操作 {#sales-insight-actions}
   + [總覽](sales-insight-actions/overview.md)
   + [銷售分析操作概述](sales-insight-actions/sales-insight-actions-overview.md)
   + [訪問您的銷售分析操作實例](sales-insight-actions/accessing-your-sales-insight-actions-instance.md)
...
+ 銷售機會和資料管理 {#lead-and-data-management}
   ...
   + [[!UICONTROL 銷售機會生命週期]](lead-and-data-management/lead-lifecycle-learn.md)
